1. Figure out a clean solution for deleting items that currently exist inside of the outfits, maybe keep the image?
2. Add an archive option for clothes items
3. add a cloudflare worker app
  - a worker for daily db backups and another for daily r2 image backups
4. Solve item delete / outfit reference race conditions
